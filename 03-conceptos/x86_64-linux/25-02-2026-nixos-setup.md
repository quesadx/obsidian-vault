...
Go to **[https://www.netacad.com/resources/lab-downloads](https://www.netacad.com/resources/lab-downloads)**, log in with a Cisco NetAcad account, and download:

```
CiscoPacketTracer_900_Ubuntu_64bit.deb
```

### Step 2 — Add it to the Nix store
