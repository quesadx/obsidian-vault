...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Universidad Nacional"
Config.profilename = "UNA"
Config.url = "your local eduroam® support page"
Config.email = "eduroam@una.ac.cr"
Config.title = "eduroam CAT"
Config.server_match = "radius.una.cr"
...
Config.user_realm = "una.cr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.una.cr']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
